...
>>>>>>> 699a7db619205412c49c965e56fee9f9a690c0e2
...
>>>>>>> 699a7db619205412c49c965e56fee9f9a690c0e2
  ...
  return (
    <section ref={sectionRef} className="relative text-black py-20">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div
            className={`transition-all duration-700 transform ${
              isVisible
                ? "opacity-100 translate-x-0 animate__fadeInRight"
          ...
          >
            ...
            <p className="text-lg font-serif mb-8">
              ...
              (Shirdi), Ahmednagar, is a distinguished multispecialty healthcare
              center renowned for its advanced medical treatments and
              state-of-the-art facilities. The hospital is equipped with
              cutting-edge technology, including a Canada-made photonics laser
              system, and is committed to delivering minimally invasive
              procedures that ensure reduced discomfort and expedited recovery.
            </p>
            <h3 className="text-xl md:text-2xl font-semibold text-black mb-4">
              Harmony Laser Clinic
            </h3>
            <p className="text-lg font-serif mb-8">
              The Harmony Laser Clinic, a specialized division of the hospital,
              offers expertise in cosmetic gynecology and andrology, addressing
